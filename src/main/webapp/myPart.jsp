...
<%
	...
	if (storyId == null) {
		...
		List<storyPart> listPart = partDAO.getPartsByStoryId(storyId);
...
<title>My Part - Storylines</title>
<style>
    body {
...
<body>
    ...
    <div class="container">
        ...
        <nav class="tabs">
        	<a href="publishPart.jsp">Published</a>
        	<a href="myPart.jsp" class="active">All Parts</a>
        </nav>
                ...
                <tr>
                    <td>
                    	<a href="readPartPreview.jsp?id=${part.id}" class="publish-title">
                    		<b><c:out value="${part.title}" /></b>
                    	</a><br><br>
                    	<small>
                    		<c:out value=" ${part.status == 'published' ? 'PUBLISHED' : '(draft)'}" />
